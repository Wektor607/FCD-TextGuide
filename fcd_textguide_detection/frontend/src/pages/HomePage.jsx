      ...
      <main className="home-container">
        <div className="card-home">
          ...
          <p>
            ...
            However, the detection of FCD is considerably more challenging. 
            ...
            In addition, publicly available annotated datasets for FCD are highly limited. 
          </p>

          <p>
            To address these limitations, this project proposes a novel multimodal segmentation framework that combines surface-based visual features with text-based inputs that guide the segmentation process. 
          ...
          <div className="button-row">
            <a
              href="https://github.com/Wektor607/FCD-Detection/blob/docker-inference-fix/meld_graph/README.md"
              className="btn"
            >
              Documentation
            </a>
